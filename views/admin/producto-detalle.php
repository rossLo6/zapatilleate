                        ...
                        <div class="card-body">
                            <form class="admin-form" onsubmit="return updateProducto(this)">
                                ...
                                <div>
                                    ...
                                    <input id="nombre" class="cuadros" name="nombre" type="text" value="<?php echo $producto["nombre"]?>" required/>
                                </div>
                                <div>
                                    <label for="precio" class="label">Precio: </label>
                                    <input id="precio" class="cuadros" name="precio" type="number" value="<?php echo $producto["precio"]?>" required/>
                                </div>
                                <div>
                                    <label for="imagen" class="label">Imagen: </label>
                                    <input id="imagen" class="cuadros" name="imagen" type="text" value="<?php echo $producto["imagen"]?>"/>
                                </div>
                                <div>
