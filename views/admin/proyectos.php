<?php
    ...
    $sql = "SELECT proyectos.*, users_data.nombre as usuario, productos.nombre as producto FROM `proyectos` INNER JOIN `users_data` ON fk_idUsuario = idUsuario INNER JOIN `productos` ON fk_idProducto = idProducto";
