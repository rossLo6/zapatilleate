                        ...
                        <div class="card-body">
                            <form class="admin-form" onsubmit="return updateNoticia(this)">
                                ...
                                <div>
                                    ...
                                    <input id="titulo" class="cuadros" name="titulo" type="text" value="<?php echo $noticia["titulo"]?>" required/>
                                </div>
                                <div>
                                    <label for="cuerpo" class="label">Cuerpo: </label>
                                    <input id="cuerpo" class="cuadros" name="cuerpo" type="text" value="<?php echo $noticia["cuerpo"]?>" required/>
                                </div>
                                <div>
                                    <label for="imagen" class="label">Imagen: </label>
                                    <input id="imagen" class="cuadros" name="imagen" type="text" value="<?php echo $noticia["imagen"]?>" required/>
                                </div>
                                <div>
